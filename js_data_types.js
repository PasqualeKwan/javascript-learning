...
console.log(typeof instanceCount) // Ouputs: number
console.log(typeof cpuUtilization) // Ouputs: number
...
if (configFile === undefined) {
    console.log("Config file not loadeed");
...
const ec2Instance = {
    ...
    type: 't2.micro',
    status: 'running',
    iaunchTime: new Date('2023-09-15T10:00:00Z')
};
...
availabilityZones.forEach(zone => {
    console.log(`Deploying to ${zone}`); // Must use the backquote (`)
});
